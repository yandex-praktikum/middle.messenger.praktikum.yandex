import s from './ChatSubmit.module.scss'

export function ChatSubmit() {
    return (
        `
        <div class=${s.wrapper}>
            <button class=${s.wrapper__more}>
            ...
            <input type='text' name='message' class=${s.wrapper__input} placeholder='Сообщение' />
            <button class=${s.wrapper__submit}>
