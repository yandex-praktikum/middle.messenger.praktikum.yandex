...
export default class Block<P extends Record<string, any> = any> {
  ...
  /**
   * @description this method is called from the heir element
   * (Button, Input, page etc..) as render()
   *
  ...
  protected compile(template: (context: any) => string, context: any) {
    ...
    /**
     * @description Replaces a dummy element with a real one,
     * storing all childNodes in the component
     *
